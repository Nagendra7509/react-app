        ...
        return (
            <div>
                        {this.shouldDisplayCart?
                              <div class="flex cart-container fixed cart-container-open top-0 right-0 z-10 w-1/3 overflow-x-hidden h-full flex-1  ">
                                    ...
                                    <div class="cart-items p-4 bg-gray-800 flex flex-col justify-between w-full">
                                          <div class="flex items-center justify-center">
                                                <div class="h-10 mr-4">
                                                      ...
                                                      <p class=" -mt-8 pl-2 text-center text-sm text-yellow-600 relative cart-position">{noOfProductsInCart}</p>
                                                </div>
                                          ...
                                          <div class="absolute bottom-0 right-0 p-4 total-checkout bg-gray-800 shadow-inner w-11/12">
